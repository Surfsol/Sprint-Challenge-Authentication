...
to to put cookies on a clients browser, for authentication
1. What does bcrypt do to help us store passwords in a secure manner.
it will hash the password, and make it difficult to someone to decifer
1. What does bcrypt do to slow down attackers?
can increase rounds, so it takes longer to get hashed passwords
